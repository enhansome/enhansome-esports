...
* [Discord.js](https://github.com/discordjs/discord.js) ⭐ 26,827 | 🐛 163 | 🌐 TypeScript | 📅 2026-09-21 - A Node.js library for interacting with the Discord API.
...
* [Passport-Steam](https://github.com/liamcurry/passport-steam) ⭐ 358 | 🐛 23 | 🌐 JavaScript | 📅 2026-04-02 - A Node.js passport authentication strategy for Steam.
...
* [Clarity](https://github.com/skadistats/clarity) ⭐ 767 | 🐛 11 | 🌐 Java | 📅 2026-07-22 - A Java library for parsing CS:GO and Dota 2 replays.
* [awpy](https://github.com/pnxenopoulos/awpy) ⭐ 613 | 🐛 30 | 🌐 Python | 📅 2026-09-20 - A Python library for parsing, analyzing, and visualizing CS:GO data.
...
* [Boxcars](https://github.com/nickbabcock/boxcars) ⭐ 148 | 🐛 8 | 🌐 Rust | 📅 2026-08-30 - A Rust library for parsing Rocket League replays.

### Team management

* [LoL in-house bot](https://github.com/mrtolkien/inhouse_bot) ⭐ 115 | 🐛 2 | 🌐 Python | 📅 2022-11-22 - A Discord bot handling role queue, matchmaking, and rankings for League of Legends in-house games.

### Tournaments management

* [brackets-manager.js](https://github.com/Drarig29/brackets-manager.js) ⭐ 332 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-20 - A JavaScript library to manage tournament brackets.
...
* [Open Dota](https://github.com/odota/core) ⭐ 1,627 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-20 - A website for Dota 2 esports stats.

**League of Legends**

* [LeagueDirector](https://github.com/RiotGames/leaguedirector) ⭐ 1,020 | 🐛 41 | 🌐 Python | 📅 2026-01-08 - A desktop application for staging and recording videos from League of Legends replays.
